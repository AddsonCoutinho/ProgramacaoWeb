 ...
 */
public class EditarTarefa implements Command{

    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        TarefaDAO dao = new TarefaDAO();
        dao.editarTarefa(request.getParameter("nome"),request.getParameter("descricao"),Integer.parseInt(request.getParameter("id")));
