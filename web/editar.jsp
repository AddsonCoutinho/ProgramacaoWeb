<%-- 
    Document   : newjsp
    Created on : 06/11/2019, 13:07:49
...
<html>
   ...
   <style>
    ...
    <body>
        <div id="header">
            <h1 id ="logo">Gerenciador de Processos</h1>
        <button class="botao">Logout</button>
        <p id ="user">Olá, <strong>${user} usuario </strong></p>
        
        
        </div>
        <div id="main">    
        <c:if test="${not novoProcesso}">
        <div><h3>Editar Processo</h3>
            <form action="Servlet" method="post" >
                <input type="hidden" name="acao" value="criarProcesso"/>
                <fieldset class="form-group">
                    <label for="nome"><strong>Nome do Processo:</strong><br></label>
            ...
            <div id="tarefas"><h3>Tarefa <c:out value="${tarefa+1}"/> </h3>
                <form action="Servlet" method="post" >
                    ...
                    <fieldset class="form-group">
                        ...
                        <strong>Nome:</strong>
                        <input class="form-control" type="text" name="nome" size="32" maxlength="40" /><br>
                        <strong>Descrição</strong>
                        <input class="form-control" type="text" name="descricao" size="32" maxlength="40" />
